...
function car2_up()
{
	if(car1Y >=0)
	{
		...
		car2Y = car2Y - 10;
		console.log("quando a letra w é pressionada, x="+ car1X +"| y" +car1Y);
		uploadBackground();
			uploadcar1();
 uploadcar2();
...
function car2_down()
{
	if(car1Y <=500)
	{
		...
		car2Y = car2Y + 10;
		console.log("quando a letra  s é pressionada, x="+ car1X +"| y" +car1Y);
		uploadBackground();
			uploadcar1();
 uploadcar2();
...
function car2_left()
{
	if(car1X >=0)
	{
		...
		car2X = car2X - 10;
		console.log("quando a letra a é pressionada, x="+ car1X +"| y" +car1Y);
		uploadBackground();
			uploadcar1();
 uploadcar2();
...
function car2_right()
{
	if(car2X <=700)
	{
		...
		car2X = car2X + 10;
		console.log("quando a letra  d é pressionada, x="+ car1X +"| y" +car1Y);
		uploadBackground();
			uploadcar1();
 uploadcar2();
